...
try:
    ...
    MemoryManager = importlib.import_module('.memory.manager', __name__).MemoryManager
except (ImportError, AttributeError):  # pragma: no cover - optional legacy component
    MemoryManager = None
